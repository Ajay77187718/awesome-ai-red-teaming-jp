...
- [Cisco AI Defense](https://www.cisco.com/site/us/en/products/security/ai-defense/index.html) - MCPサーバーの発見・インベントリ・リスク管理を含む商用AIセキュリティソリューション
- [HiddenLayer](https://hiddenlayer.com/) - AIモデルのセキュリティとコンプライアンスの継続的監視
- [Robust Intelligence (Cisco)](https://www.cisco.com/site/us/en/products/security/ai-defense/index.html) - AIモデルのバリデーションとファイアウォール。Cisco AI Defenseに統合
...
- [AIセーフティに関するレッドチーミング手法ガイド v1.10](https://aisi.go.jp/assets/pdf/E1_ai_safety_RT_v1.10_en.pdf) - AIセーフティ研究所によるレッドチーミング手法の体系的ガイド（2025年3月）
